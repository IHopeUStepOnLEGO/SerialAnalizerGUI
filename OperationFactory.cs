...
namespace SerialGUI
{
    class OperationFactory
    {
        ...
        public void addReadOperationToForm(Form targetForm, Point originPoint, int dataByteCount, int iterationCounter = 1)
        {
            ...
            if (targetForm.Controls.Find("readOperationGroupBox", false).FirstOrDefault() as GroupBox == null)
            {
                ...
                readOperationGroupBox.Location = new Point(_groupBoxWidth+20, 0);
        ...
        public void addWriteOperationToForm(Form targetForm, Point originPoint, int dataByteCount, int iterationCounter = 1)
        {
